 ...
 *
 *   hash: b2b1ac353eb52b692f529ebaf821f36b19e671e8
 *
...
enum AOC_COMMAND {
  ...
  CMD_AUDIO_INPUT_SET_HDMIC_GAIN_ID = 364, /* [0x016c] ->  struct CMD_AUDIO_INPUT_SET_HDMIC_GAIN */
};
 ...
 * Structure associated with the following commands:
 *
 *   CMD_AUDIO_INPUT_SET_HDMIC_GAIN_ID, UUID: c5e0ef72c71e47625bd1f601b2f3bbaf
 */
...
static inline int AocInterfaceCheck(const void * addr, int size) {
  static const uint8_t uuid_array[AOC_UUID_ENTRIES][AOC_UUID_SIZE] = { 
      ...
      { 0xc5, 0xe0, 0xef, 0x72, 0xc7, 0x1e, 0x47, 0x62, 0x5b, 0xd1, 0xf6, 0x01, 0xb2, 0xf3, 0xbb, 0xaf},
